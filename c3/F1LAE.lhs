...
\texttt{LAE} program introduces \texttt{x} and then immediately
...
with the number $10$, then complain that no such function
...
and let the context determine in which space to lookup a name? Languages
